            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="py-8">
                    ...
                    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                        <div v-for="order in orders" class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                            <table class="min-w-full leading-normal">
                                <thead>
                                    <h2>Commande n° {{ order?.order_number }} passée le {{ order?.created_at }}</h2>
                                    <tr>
                                        <th
                                ...
                                <tbody>
                                    <tr v-for="product in order?.products">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap">{{ formatMoney(product.pivot.total_price / 100, 'fr-FR', 'EUR') }}</p>
                                        </td>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap">
